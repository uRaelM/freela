...
export default function TecnologiaQuery() {
  ...
  return (
    ...
    >
      ...
      <section style={{ marginTop: "3rem" }}>
        ...
        <h2>
          Desenvolvimento de site de negócios. Obtenha os melhores serviços
          freelance para concluir seus projetos com sucesso.
        </h2>
      </section>
